...
// ... estilos StyledHeader, Logo, Bonus, JackpotBonus, RightGroup, PopupContainer, CloseButton, ClaimButton (sin cambios)
...
export default function Header() {
  ...
  const [showLeaderboard, setShowLeaderboard] = React.useState(false) // NUEVO
  ...
  return (
    <>
      ...
      {showLeaderboard && (
        <LeaderboardsModal
          creator={
            typeof PLATFORM_CREATOR_ADDRESS === 'string'
      ...
      {/* Espacio fantasma solo en móviles */}
