...
const ModalCard = styled.div`
  background: linear-gradient(135deg, rgba(6, 10, 12, 0.8), rgba(18, 23, 36, 0.9));
  border-radius: 20px;
  padding: 24px;
  ...
  animation: ${glow} 4s ease-in-out infinite, fadeInScale 0.5s ease-out;
    ...
    <Modal onClose={() => user.set({ userModal: false })}>
      ...
      <ModalCard>
        ...
        <StatsSection>
          ...
          <SubtleText style={{ fontSize: '11px', marginTop: '8px' }}>
            Stats will be updated with real data from blockchain
          </SubtleText>
        </StatsSection>
