...
const jackpotGradient = keyframes`
  0% { background: linear-gradient(90deg, #ffd700, #ff4500); }
  25% { background: linear-gradient(90deg, #ff4500, #32cd32); }
  50% { background: linear-gradient(90deg, #32cd32, #1e90ff); }
  75% { background: linear-gradient(90deg, #1e90ff, #ffd700); }
  100% { background: linear-gradient(90deg, #ffd700, #ff4500); }
`
