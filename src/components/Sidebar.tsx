...
const HeaderContainer = styled.div`
  ...
  @media (max-width: 768px) {
    ...
    height: 75px;
    padding: 0 15px;
    /* Layout móvil: elementos alineados completamente a la derecha */
    display: flex;
...
const NavIcon = styled(Link)`
  ...
  &:hover {
    color: #ffe42d;
    background: linear-gradient(135deg,
      rgba(255, 228, 45, 0.18) 0%,
      rgba(167, 139, 250, 0.12) 50%,
      rgba(138, 43, 226, 0.08) 100%);
    box-shadow:
      0 8px 24px rgba(255, 228, 45, 0.25),
  ...
  &.active {
    color: #ffe42d;
    background: linear-gradient(135deg,
      rgba(255, 228, 45, 0.25) 0%,
      rgba(167, 139, 250, 0.18) 50%,
      rgba(138, 43, 226, 0.12) 100%);
    box-shadow:
      0 10px 28px rgba(255, 228, 45, 0.4),
  ...
  &.home-icon {
    ...
    background: linear-gradient(135deg,
      rgba(255, 228, 45, 0.1) 0%,
      rgba(167, 139, 250, 0.08) 100%);
    box-shadow:
      0 4px 16px rgba(255, 228, 45, 0.2),
...
const Sidebar = ({ onShowLeaderboard }: { onShowLeaderboard?: () => void }) => {
  return (
    <SidebarContainer>
      {/* Home */}
      <NavIcon to="/" title="Home" className="home-icon">
        <img src="https://i.ibb.co/3ZLQjJC/newlogopng.png" alt="Home" />
      </NavIcon>
